...
public:
   static int32_t h_GetOscComDriverParamFromView(const uint32_t ou32_ViewIndex, uint32_t & oru32_ActiveBusIndex,
                                                 ...
                                                 stw::opensyde_core::C_OscIpDispatcher ** const oppc_IpDispatcher, const bool oq_InitCan, const bool oq_IgnoreUpdateRoutingErrors, bool * const opq_DashboardRoutingErrors);
};
